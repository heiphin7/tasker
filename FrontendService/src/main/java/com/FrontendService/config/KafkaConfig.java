...
public class KafkaConfig {
    ...
    // Конфигурация для Producer с Task
    @Bean
    public ProducerFactory<String, Task> taskProducerFactory() {
        ...
        configProps.put(JsonSerializer.ADD_TYPE_INFO_HEADERS, false);  // 🆕 Отключаем @class из JSON
    ...
    // Конфигурация для Admin (создание топиков)
    @Bean
